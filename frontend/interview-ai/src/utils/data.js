export const APP_FEATURES = [
  {
    ...
    description:
      "Get interview questions and model answers based on your role, experience, and specific focus areas – no one-size-fits-all.",
  },
  {
    id: "02",
  ...
  {
    id: "05",
    title: "AI-Powered Concept Explanations",
    description:
      "Beyond just answers – unlock detailed concept explanations generated by AI, helping you truly master each topic.",
  },
];
